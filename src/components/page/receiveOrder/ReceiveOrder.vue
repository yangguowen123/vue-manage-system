<template>
    <div>
        <div id="receiveOrder" v-cloak>
            <div class="page-body" v-show="showReceiveOrderPageFlag">
                ...
                <div class="receive-order-channel-area">
                    <div class="receive-order-channel" v-for="(channel, index) in channels" :key="index">
                ...
                <div class="receive-order" v-show="receiveOrderState == '1'">
                    ...
                    <div class="platform-order-list-area">
                        <div class="form-details" v-for="(order, index) in waitReceivingOrders" :key="index">
            ...
            <div class="page-body" v-show="showSwitchPayeePageFlag">
                <ul class="nav nav-tabs nav-justified">
                    <li class="nav-item common-nav-item" v-for="(channel, index) in channels" :key="index" v-bind:class="{'common-nav-item-active': channel.channelId == gatheringChannelId}"
                ...
                <div class="form-details" v-for="(gatheringCode, index) in gatheringCodes" :key="index" v-show="gatheringChannelId == gatheringCode.gatheringChannelId">
        ...
        <view-system-notice-modal ref="viewSystemNoticeModal"></view-system-notice-modal>
    </div>
</template>
<script>
import ViewSystemNoticeModal from '@/components/common/ViewSystemNoticeModal';
...
export default {
    ...
    mounted : function() {
        ...
        this.$refs.viewSystemNoticeModal.getLatestNotice();
    },
    methods : {
        ...
        loadReceiveOrderSoundSetting : function() {
            ...
            that.$http.get('/masterControl/getReceiveOrderSetting').then(function(res) {
                that.receiveOrderSound = res.data.receiveOrderSound;
                that.openAutoReceiveOrder = res.data.openAutoReceiveOrder;
                that.dispatchMode = res.data.dispatchMode;
            });
        },
        ...
        checkStopReceiveOrderState : function() {
            ...
            that.$http.get('/userAccount/getUserAccountInfo').then(function(res) {
                that.receiveOrderState = res.data.receiveOrderState;
        ...
        loadPlatformOrder : function() {
            ...
            that.$http.get('/merchantOrder/findMyWaitReceivingOrder').then(function(res) {
                that.waitReceivingOrders = res.data;
