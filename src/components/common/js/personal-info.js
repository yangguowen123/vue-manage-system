	...
	methods : {
		...
		showGoogleSecretKeyPage : function() {
			...
			that.$http.get('/userAccount/getGoogleAuthInfo', {
				...
				that.googleSecretKey = res.data.googleSecretKey;
				that.googleAuthBindTime = res.data.googleAuthBindTime;
